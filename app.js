...
function showTypingIndicator() { const el = document.createElement("div"); el.className = "bot-msg typing"; el.innerHTML = "Misha AI sedang mengetik<span class='dot'>.</span><span class='dot'>.</span><span class='dot'>.</span>"; chatMessages.appendChild(el); chatMessages.scrollTop = chatMessages.scrollHeight; return el; }
...
try {
  const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
    ...
    body: JSON.stringify({
      model: "gpt-3.5-turbo",
      messages: [
        { role: "system", content: "Kamu adalah Misha AI, asisten ramah, imut, dan cerdas yang berbicara dalam bahasa Indonesia. Saat kamu menanyakan sesuatu kepada pengguna, gunakan gaya lembut dengan menyebut dirimu 'Misha', misalnya 'Bisa Misha bantu?'" },
